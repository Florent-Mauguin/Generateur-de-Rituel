...
export const liturgyRules = {
  ...
  "christmas_time_january_2": {
        CelebrationduJour: "",
        ChoixOraison: "",
        PrefacesOptionnelles: [{ id: "1NS", label: "1" }, { id: "2NS", label: "2" }, { id: "3NS", label: "3" }],
        typeCredo: "NC",
  ...
  "epiphany_of_the_lord": {
        ...
        ChoixOraison: "EPI_JOU",
        Choixpreface: "1E",
        typeCredo: "NC",
        celebrationType: "Dominicale",
        Communicantes: "Epiphanie",
        Benediction: "Epiphanie"
    }, 
  "monday_after_epiphany": {
        CelebrationduJour: "Lundi après l'Épiphanie du Seigneur",
        ChoixOraison: "EPI_L",
        PrefacesOptionnelles: [{ id: "1E", label: "1" }, { id: "1NS", label: "2" }, { id: "2NS", label: "3" }, { id: "3NS", label: "4" }],
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
    },
  ...
  "ash_wednesday": {
        ...
        ChoixOraison: "CEN",
        PrefacesOptionnelles: [{ id: "3CA", label: "1" }, { id: "4CA", label: "2" }], //A remplir
        typeCredo: "NC",
        celebrationType: "Dominicale",
        Communicantes: "Dimanche"
    },
  "thursday_after_ash_wednesday": {
        ...
        ChoixOraison: "CEN_J",
        PrefacesOptionnelles: [{ id: "1CA", label: "1" }, { id: "2CA", label: "2" }, { id: "3CA", label: "3" }, { id: "4CA", label: "4" }],
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
    },
  ...
  "palm_sunday_of_the_passion_of_the_lord": {
        ...
        RituelduJour: "rameaux",
        hideritesInitiaux: true,
        hideLiturgieParole: true,
        ChoixOraison: "RAM",
        Choixpreface: "1DR",
        typeCredo: "NC",
        celebrationType: "Dominicale",
  ...
  "thursday_of_the_lords_supper": {
        ...
        typeCredo: "NC",
        celebrationType: "Solennité",
        Communicantes: "jeudisaint",
        RituelduJour: "jeudisaint",
        precision:"jeudisaint",
        hideritesdeConclusion: true
    },
  "friday_of_the_passion_of_the_lord": {
        CelebrationduJour: "Office de la Passion du Seigneur",
        RituelduJour: "vendredisaint",
        hideritesdeConclusion: true,
        hideLiturgieParole: true,
        hideliturgieeucharistique: true,
        hideritesInitiaux: true,
    },
  "holy_saturday": {
        CelebrationduJour: "Vigile Pascale",
        RituelduJour: "vigilepascale",
        hideLiturgieParole: true,
        hideritesInitiaux: true,
        Choixpreface: "1PA",
        ChoixOraison: "VIG",
  ...
  "easter_time_2_monday": {
        ...
        ChoixOraison: "2PA_L",
        PrefacesOptionnelles: [{ id: "1PA", label: "1" }, { id: "2PA", label: "2" }, { id: "3PA", label: "3" }, { id: "4PA", label: "4" }, {id:"5PA", label: "5" }],
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
    },
  ...
  "ascension_of_the_lord": {
        ...
        ChoixOraison: "ASC",
        Choixpreface: "", //problèmes !!!
        typeCredo: "NC",
        celebrationType: "Solennité",
        Communicantes: "Ascension"
    },
  ...
  "ordinary_time_1_monday": {
        ...
        ChoixOraison: "1TO",
        PrefacesOptionnelles: [{id: "1CO", label: "1"},{id: "2CO", label: "2"},{id: "3CO", label: "3"},{id: "4CO", label: "4"},{id: "5CO", label: "5"},{id: "6CO", label: "6"}],
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
    },
  ...
  "ordinary_time_2_sunday": {
        ...
        ChoixOraison: "2TO",
        PrefacesOptionnelles: [{id: "1DO", label: "1"},{id: "2DO", label: "2"},{id: "3DO", label: "3"},{id: "4DO", label: "4"},{id: "5DO", label: "5"},{id: "6DO", label: "6"},{id: "7DO", label: "7"},{id: "8DO", label: "8"}],
        typeCredo: "NC",
        celebrationType: "Dominicale",
        Communicantes: "Dimanche"
    },
  ...
  "ordinary_time_27_friday": {
        CelebrationduJour: "",
        ChoixOraison: "27TO",
        Choixpreface:   ["1CO","2CO","3CO","4CO","5CO","6CO"],
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
    },
  ...
  "conversion_of_saint_paul_the_apostle": {
        CelebrationduJour: "",
        ChoixOraison: "CONV",
        Choixpreface: "", //apotre 1
        typeCredo: "NC",
        celebrationType: "Fête",
        Communicantes: "Semaine"
        //bénédiction solennelle possible
    },
...
//+procession
  ...
  "josephine_bakhita_virgin": {
        CelebrationduJour: "Sainte Joséphine Bakhita, vierge",
        ChoixOraison: "STE_JOS",
  ...
  "gregory_of_narek_abbot": {
        CelebrationduJour: "",
        ChoixOraison: "ST_GRE_N",
        CommunOptions: [{ id: "CSMRA", label: "Commun des saints pour un abbé" }, { id: "CDDDE_I", label: "Commun des docteurs 1" }, { id: "CDDDE_II", label: "Commun des docteurs 2" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
  ...
  "john_of_god_duarte_cidade_religious": {
        CelebrationduJour: "",
        ChoixOraison: "ST_JEA_D",
        CommunOptions: [{ id: "CSSAC", label: "Commun des saints ayant exercé une activité caritative" }, { id: "CSMRR_I", label: "Commun des saints religieux 1" }, { id: "CSMRR_II", label: "Commun des saints religieux 2" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
...
//Pour l'annonciation, ajouter genoux à terre pdt le credo
  "annunciation_of_the_lord": {
        ...
        typeCredo: "NC",
        celebrationType: "Solennité",
        Communicantes: "Assomption"
    },
  "francis_of_paola_hermit": {
        CelebrationduJour: "",
        ChoixOraison: "ST_FRA_P",
        CommunOptions: [{ id: "CSMRR_I", label: "Commun des saints religieux 1" }, { id: "CSMRR_II", label: "Commun des saints religieux 2" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
  ...
  "vincent_ferrer_priest": {
        CelebrationduJour: "",
        ChoixOraison: "ST_VIN_F",
        CommunOptions: [{ id: "CPPDM_I", label: "Commun des pasteurs missionnaires 1" }, { id: "CPPDM_II", label: "Commun des pasteurs missionnaires 2" }, { id: "CPPDM_III", label: "Commun des pasteurs missionnaires 3" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
  ...
  "george_of_lydda_martyr": {
        CelebrationduJour: "",
        ChoixOraison: "ST_GEO",
        CommunOptions: [{ id: "CMDUM", label: "Commun des martyrs" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
  ...
  "adalbert_of_prague_bishop": {
        CelebrationduJour: "",
        ChoixOraison: "ST_ADA",
        CommunOptions: [{ id: "CMDUM", label: "Commun des martyrs" }, { id: "CPPUE_I", label: "Commun des pasteurs évêques 1" }, { id: "CPPUE_II", label: "Commun des pasteurs évêques 2" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
  ...
  "fidelis_of_sigmaringen_priest": {
        CelebrationduJour: "",
        ChoixOraison: "ST_FID",
        CommunOptions: [{ id: "CMDUM", label: "Commun des martyrs" }, { id: "CPPUP_I", label: "Commun des pasteurs 1" }, { id: "CPPUP_II", label: "Commun des pasteurs 2" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
  ...
  "peter_chanel_priest": {
        CelebrationduJour: "",
        ChoixOraison: "ST_PIE_C",
        CommunOptions: [{ id: "CMDUM", label: "Commun des martyrs" }, { id: "CPPDM_I", label: "Commun des pasteurs missionnaires 1" }, { id: "CPPDM_II", label: "Commun des pasteurs missionnaires 2" }, { id: "CPPDM_III", label: "Commun des pasteurs missionnaires 3" }],
        Choixpreface: "",
        typeCredo: "NC",
        celebrationType: "Semaine",
        Communicantes: "Semaine"
...
// A completer
  ...
  /* Exemple d'entrée pour une fête spécifique
    ...
    "nativity_of_the_lord": {
        ...
        couleur: "blanc", // Juste pour info ou usage CSS futur
